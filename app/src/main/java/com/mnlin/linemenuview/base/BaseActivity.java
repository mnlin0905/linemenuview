...
import com.mnlin.linemenuview.dagger.component.ActivityComponent;
import com.mnlin.linemenuview.dagger.component.DaggerActivityComponent;
import com.mnlin.linemenuview.dagger.module.ActivityModule;
import com.mnlin.linemenuview.drawable.ColorTextDrawable;
import com.mnlin.linemenuview.rxbus.RxBus;
import com.mnlin.linemenuview.util.ActivityUtil;
...
public abstract class BaseActivity<T extends BasePresenter> extends AppCompatActivity implements BaseView {
    ...
    protected void showSnackbar(String msg, String button, View.OnClickListener onClickButton) {
        ...
        singleSnackbar.setActionTextColor(getThemeColorAttribute(com.mnlin.linemenuview.R.style.TextInputLayout_HintTextAppearance_Hacker, android.R.attr.textColor));
    ...
    public int getThemeColorAttribute(int styleRes, int colorId) {
        int defaultColor = dispatchGetColor(com.mnlin.linemenuview.R.color.transparent);
