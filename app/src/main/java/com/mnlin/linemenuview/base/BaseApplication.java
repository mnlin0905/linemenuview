package com.mnlin.linemenuview.base;
...
import com.mnlin.linemenuview.BuildConfig;
import com.mnlin.linemenuview.R;
import com.mnlin.linemenuview.dagger.component.ApplicationComponent;
import com.mnlin.linemenuview.dagger.component.DaggerApplicationComponent;
import com.mnlin.linemenuview.dagger.module.ApplicationModule;
import com.mnlin.linemenuview.retrofit.HttpInterface;
import com.mnlin.linemenuview.rxbus.RxBus;
import com.mnlin.linemenuview.util.Const;
import com.mnlin.linemenuview.util.DefaultPreferenceUtil;
import com.mnlin.linemenuview.window.DoLoginDialog;
...
public class BaseApplication extends Application {
    ...
    //活动管理
    static ArrayList<Stack<com.mnlin.linemenuview.base.BaseActivity>> activityManager;
    //当前是否处于严格模式
    ...
    private void init() {
        ...
        RxBus.getInstance().toObservable(com.mnlin.linemenuview.base.BaseEvent.class).observeOn(AndroidSchedulers.mainThread()).subscribe(baseEvent -> {
